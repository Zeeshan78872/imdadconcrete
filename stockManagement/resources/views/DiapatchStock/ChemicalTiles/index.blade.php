                    ...
                    <table class="table table-bordered" id="">
                        <thead class="">
                            <tr>
                                ...
                                <th scope="col" colspan="5">Color's Quantity</th>
                        ...
                        <tbody>
                            @foreach ($dispatches as $dispatch)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $dispatch->products?->first()?->black_qty }}</td>
                                    <td>{{ $dispatch->products?->first()?->yellow_qty }}</td>
                                    <td>{{ $dispatch->products?->first()?->white_qty }}</td>
                                ...
                                @if ($count > 1)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $product->black_qty }}</td>
                                        <td>{{ $product->yellow_qty }}</td>
                                        <td>{{ $product->white_qty }}</td>
