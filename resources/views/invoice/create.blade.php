            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('invoice.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="invoice_no" class="form-label text-blod">Invoice No</label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="from_date" class="form-label text-blod">From Date</label>
                                <input type="date" class="form-control" name="from_date" id="from_date" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="to_date" class="form-label text-blod">To Date</label>
                                <input type="date" class="form-control" name="to_date" id="to_date" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="searchableSelect" class="form-label text-blod">Customer Name</label>
