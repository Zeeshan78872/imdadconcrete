                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control  @error('length') is-invalid @enderror"
                                    onchange="CalTotalPrice()" name="length" value="{{ $gravelSand->length }}"
                                    id="length" aria-describedby="helpId" placeholder="">
                                @error('length')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control  @error('width') is-invalid @enderror"
                                    onchange="CalTotalPrice()" name="width" value="{{ $gravelSand->width }}"
                                    id="width" aria-describedby="helpId" placeholder="">
                                @error('width')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control @error('height') is-invalid @enderror "
                                    onchange="CalTotalPrice()" name="height" value="{{ $gravelSand->height }}"
                                    id="height" aria-describedby="helpId" placeholder="">
                                @error('height')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
