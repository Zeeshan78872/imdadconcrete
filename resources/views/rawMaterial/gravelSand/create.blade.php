                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select form-select-md @error('material_type') is-invalid @enderror"
                                    ...
                                    @foreach ($materialTypes as $type)
                                        <option {{ old('material_type') == $type ? 'seelected' : '' }}
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <input type=" "
                                    ...
                                    onchange="CalTotalPrice()" name="length" onkeyup="setupnumValid('length')"
                                    value="{{ old('length') }}" id="length" aria-describedby="helpId" placeholder="">
                                @error('length')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control number-input @error('width') is-invalid @enderror"
                                    onchange="CalTotalPrice()" name="width" value="{{ old('width') }}"
                                    onkeyup="setupnumValid('width')" id="width" aria-describedby="helpId"
                                    placeholder="">
                                @error('width')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <input type="text"
                                    ...
                                    onchange="CalTotalPrice()" name="height" value="{{ old('height') }}"
                                    onkeyup="setupnumValid('height')" id="height" aria-describedby="helpId"
                                    placeholder="">
                                @error('height')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select form-select-md @error('seller_name') is-invalid @enderror"
                                    ...
                                    @foreach ($sellerNames as $name)
                                        <option {{ old('seller_name') == $name ? 'selected' : '' }}
